...
<head>
    ...
    <link href="{{ asset('storage/default/') }}/libs/datatables/datatables.min.css" rel="stylesheet" />
    @yield('css')
    @stack('css')
...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Purchase <sup>Return</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('/admin') }}">
                    ...
                    @php
                        $damagedProducts = session('damagedProducts'); 
                    @endphp
                    @if($damagedProducts > 0)
                        <span class="badge bg-danger">{{ $damagedProducts }}</span>
                    @endif
                </a>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{asset('storage/default')}}/img/undraw_profile.svg">
                            </a>
    ...
    <script src="{{ asset('storage/default/') }}/libs/datatables/datatables.min.js"></script>
